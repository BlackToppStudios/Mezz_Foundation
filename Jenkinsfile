            ...
            parallel {
                ...
                stage('UbuntuEmscripten') {
                    ...
                    steps {
                        ...
                        sh 'mkdir -p build-debug'
                        dir('build-debug') { sh """
                            cmake -E env EMCC_DEBUG=2 CXXFLAGS="-fno-var-tracking -s TOTAL_MEMORY=2147483648 -s WASM=0" cmake -G"Ninja" .. -DCMAKE_BUILD_TYPE=DEBUG -DMEZZ_BuildDoxygen=OFF -DMEZZ_CodeCoverage=OFF &&
                            ninja &&
            ...
            parallel {
                ...
                stage('UbuntuEmscripten') {
                    ...
                    steps {
                        ...
                        sh 'mkdir -p build-release'
                        dir('build-release') { sh """
                            cmake -E env EMCC_DEBUG=2 CXXFLAGS="-fno-var-tracking -s TOTAL_MEMORY=2147483648 -s WASM=0" cmake -G"Ninja" .. -DCMAKE_BUILD_TYPE=RELEASE -DMEZZ_BuildDoxygen=OFF -DMEZZ_CodeCoverage=OFF &&
                            ninja &&
                            node Foundation_Tester.js NoThreads
                        """ }
                    }
