...
#ifndef Mezz_Foundation_BaseSerializationBackEnd_h
#define Mezz_Foundation_BaseSerializationBackEnd_h
...
/// @page SerializationManual "Serialization Manual"
///
/// @section SerializationAPIStructure "Serialization API Structure"
/// This serialization system is just an api that allows creation of heiarchical structures
///
///
...
/// @brief The entry point and factory, if needed, for a serialization scheme.
/// @details This is used to create new hiearchies. Any code that affects all hiearchies should go here.
///
template <typename SerializationSchemeType>
class BaseSerializationBackEnd
{
