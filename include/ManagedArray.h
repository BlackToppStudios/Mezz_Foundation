...
#ifndef Mezz_Foundation_ManagedArray_h
#define Mezz_Foundation_ManagedArray_h

/// @file
/// @brief This file includes the declaration and definition for the ManagedArray class.
...
namespace Mezzanine
{
    ...
    public:
        ...
        using SelfType = ManagedArray<ElementType,NumElements>;
        /// @brief The type of internal buffer where our elements will be stored.
        using BufferElementType = typename std::aligned_storage<sizeof(ElementType),alignof(ElementType)>::type;
    ...
    private:
        ...
        value_type& Retrieve(size_t Index) noexcept
        ...
        const value_type& Retrieve(size_t Index) const noexcept
    ...
    public:
        ...
        /// throw an Mezzanine::Exception::CapacityError exception.
        ...
        /// @exception If the array is already full or this would exceed its capacity, this will
        /// throw an Mezzanine::Exception::CapacityError exception.
        ...
        /// @exception If the provided iterator is outside this array, an Mezzanine::Exception::OutOfRange exception
        /// will be thrown.
        ...
        /// @exception If the provided iterator range is outside this array, a Mezzanine::Exception::OutOfRange
