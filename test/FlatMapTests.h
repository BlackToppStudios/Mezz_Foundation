...
class MEZZ_LIB FlatMapTests : public Mezzanine::Testing::UnitTestGroup
{
public:
    using SequenceMapType = Mezzanine::FlatMap<int,std::string>;
    ...
    void TestCopyInsert();
    void TestMoveInsert();
    void TestHintCopyInsert();
    void TestHintMoveInsert();
    void TestRangeInsert();
    void TestInitListInsert();
    void TestEmplace();
    void TestHintEmplace();
    void TestSwap();
    void TestErase();
    void TestRangeErase();
    void TestKeyErase();
...
{//Construction
    using ConstructMapType = Mezzanine::FlatMap<std::string,int>;
...
void FlatMapTests::TestOperators()
{//Operators
    using OperatorMapType = Mezzanine::FlatMap<int,std::string>;
...
void FlatMapTests::TestAllocator()
{//Allocator
    ...
    using AllocMapType = Mezzanine::FlatMap<int,std::string>;
...
void FlatMapTests::TestIterators()
{//Iterators
    using FirstMapType = Mezzanine::FlatMap<std::string,int>;
    using SecondMapType = Mezzanine::FlatMap<std::string,SafeFloat>;
...
void FlatMapTests::TestCapacity()
{//Capacity
    ...
    using CapacityMapType = Mezzanine::FlatMap<int,std::string>;
...
void FlatMapTests::TestElementAccess()
{//Element Access
    using AccessMapType = Mezzanine::FlatMap<std::string,SafeFloat>;
...
void FlatMapTests::TestLookup()
{//Lookup
    using LookupMapType = Mezzanine::FlatMap<std::string,std::string,std::less<>>;
...
void FlatMapTests::TestCopyInsert()
...
void FlatMapTests::TestMoveInsert()
...
void FlatMapTests::TestHintCopyInsert()
...
void FlatMapTests::TestHintMoveInsert()
...
void FlatMapTests::TestRangeInsert()
...
void FlatMapTests::TestInitListInsert()
...
void FlatMapTests::TestHintEmplace()
...
void FlatMapTests::TestRangeErase()
...
void FlatMapTests::TestKeyErase()
